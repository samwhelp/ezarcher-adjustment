...
* [xed](https://archlinux.org/packages/community/x86_64/xed/)


## Arch Wiki

* [List of applications](https://wiki.archlinux.org/title/list_of_applications#Documents_and_texts) / [Documents](https://wiki.archlinux.org/title/List_of_applications/Documents)
