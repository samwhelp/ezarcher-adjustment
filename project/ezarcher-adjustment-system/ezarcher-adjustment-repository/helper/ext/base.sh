...
base_var_init () {
	...
	THE_REPO_DIR_NAME="repo"
	THE_REPO_DIR_PATH="$THE_PLAN_DIR_PATH/$THE_REPO_DIR_NAME"

	THE_REPO_MAIN_DIR_NAME="main"
	THE_REPO_MAIN_DIR_PATH="$THE_REPO_DIR_PATH/$THE_REPO_MAIN_DIR_NAME"
