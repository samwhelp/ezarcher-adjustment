...
and save to file `50_ezarcher-adjustment-modeling-mousepad.gschema.override`

then put to path `/usr/share/glib-2.0/schemas/50_ezarcher-adjustment-modeling-mousepad.gschema.override`

``` sh
sudo install -Dm644 50_ezarcher-adjustment-modeling-mousepad.gschema.override /usr/share/glib-2.0/schemas/50_ezarcher-adjustment-modeling-mousepad.gschema.override
```
...
``` sh
grep 'color-scheme' /usr/share/glib-2.0/schemas/50_ezarcher-adjustment-modeling-mousepad.gschema.override
```
