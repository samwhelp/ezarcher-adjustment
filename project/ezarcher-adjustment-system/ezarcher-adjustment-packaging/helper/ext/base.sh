...
base_var_init () {
	...
	THE_PACK_BASE_DIR_NAME="base"
	THE_PACK_BASE_DIR_PATH="$THE_PACK_DIR_PATH/$THE_PACK_BASE_DIR_NAME"

	THE_PACK_DEMO_DIR_NAME="demo"
	THE_PACK_DEMO_DIR_PATH="$THE_PACK_DIR_PATH/$THE_PACK_DEMO_DIR_NAME"

	THE_PACK_CORE_DIR_NAME="core"
	THE_PACK_CORE_DIR_PATH="$THE_PACK_DIR_PATH/$THE_PACK_CORE_DIR_NAME"

	THE_PACK_AUR_DIR_NAME="aur"
	THE_PACK_AUR_DIR_PATH="$THE_PACK_DIR_PATH/$THE_PACK_AUR_DIR_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_PACK_DIR_NAME=$THE_PACK_DIR_NAME"
	util_debug_echo "THE_PACK_DIR_PATH=$THE_PACK_DIR_PATH"

	util_debug_echo "THE_PACK_MAIN_DIR_NAME=$THE_PACK_MAIN_DIR_NAME"
	util_debug_echo "THE_PACK_MAIN_DIR_PATH=$THE_PACK_MAIN_DIR_PATH"
