...
kde_config_install_kde_keybind_raw () {
	...
	echo "install -Dm644 ./config/kde-plasma/skel/.config/kglobalshortcutsrc ${HOME}/.config/kglobalshortcutsrc"
	install -Dm644 "./config/kde-plasma/skel/.config/kglobalshortcutsrc" "${HOME}/.config/kglobalshortcutsrc"
...
kde_config_install_kde_desktop_raw () {
	...
	echo "cp -rf ./config/kde-plasma/skel/.config/. ${HOME}/.config/"
	cp -rf "./config/kde-plasma/skel/.config/." "${HOME}/.config/"


	echo "install -Dm644 ./config/kde-plasma/skel/.gtkrc-2.0 ${HOME}/.gtkrc-2.0"
	install -Dm644 "./config/kde-plasma/skel/.gtkrc-2.0" "${HOME}/.gtkrc-2.0"
