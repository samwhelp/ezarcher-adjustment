...
mod_config_mate_wm_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.mate.Marco.general theme 'Orchis-Dark'"
...
mod_config_mate_gtk_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.mate.interface gtk-theme 'Orchis-Dark'"
...
mod_config_mate_icon_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.mate.interface icon-theme 'Papirus-Dark'"
...
mod_config_mate_cursor_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.mate.peripherals-mouse cursor-theme 'Qogir'"
	gsettings set org.mate.peripherals-mouse cursor-theme 'Qogir'
