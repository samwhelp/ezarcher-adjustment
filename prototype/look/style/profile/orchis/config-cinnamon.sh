...
mod_config_cinnamon_wm_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.cinnamon.theme name 'Orchis-Dark'"
	gsettings set org.cinnamon.theme name 'Orchis-Dark'


	util_error_echo
	util_error_echo "gsettings set org.cinnamon.desktop.wm.preferences theme 'Orchis-Dark'"
...
mod_config_cinnamon_gtk_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.cinnamon.desktop.interface gtk-theme 'Orchis-Dark'"
...
mod_config_cinnamon_icon_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.cinnamon.desktop.interface icon-theme 'Papirus-Dark'"
...
mod_config_cinnamon_cursor_theme () {
	...
	util_error_echo
	util_error_echo "gsettings set org.gnome.desktop.interface cursor-theme 'Qogir'"
